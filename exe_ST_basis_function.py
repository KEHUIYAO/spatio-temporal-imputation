...
import os
import numpy as np
from dataset_synthetic import generate_ST_data_with_space_time_basis_functions
...
y, y_mean, y_std, *_ = generate_ST_data_with_space_time_basis_functions(K, L, B, seed=42)
