...
from dataset_heating import generate_heating_data
...
parser.add_argument("--config", type=str, default="base_heating.yaml")
...
foldername = (
    "./save/heating" + "_" + str(args.model) + "_" + current_time + "/"
)
